...
interface ChatMessagesContainerProps {
  ...
  workflowStatus?: "running" | "stopped" | "completed" | "failed" | "awaiting_response" | "in_progress" | "waiting" | "pending";
...
export function ChatMessagesContainer({
  ...
  const shouldShowSkeletonContent = shouldShowSkeleton ? shouldShowSkeleton() : false;
        ...
        <div className={inputContainerClassName}>
          <ChatInput
            ...
            isExecuting={
              ...
              (workflowStatus === "stopped"
                ? false
                : currentExecution?.workflowStatus === "awaiting_response")
            }
            workflowStatus={
              workflowStatus === "stopped"
                ? "stopped"
